...
class FaceMeshDetector():
    ...
    def __init__(self, staticMode = False, maxFaces = 2, refineLms = False,
                 minDetectionConf = 0.5, minTrackConf = 0.5):
        ...
        self.faceMesh = self.mpFaceMesh.FaceMesh(self.staticMode, self.maxFaces, self.refineLms,
